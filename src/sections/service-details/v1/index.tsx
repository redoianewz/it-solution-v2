      ...
      <Container>
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-10 md:sticky md:top-[76px] lg:top-[133px] 2xl:gap-[60px]">
            ...
            >
              <Image
                src="/assets/images/project-details/sidebar-phone-number-box-bg.webp"
            ...
            <div className="grid gap-30px">
              ...
              <div className="flex items-center gap-5">
                <Image
                  src={'/assets/images/service-details/person-3.webp'}
                  width={66}
                  height={66}
          ...
          <div className="grid gap-6">
            <div className="relative mb-5 overflow-hidden rounded-5">
              <Image
                src={'/assets/images/service-details/main-image-1.webp'}
            ...
            <div className="my-10 grid items-center gap-8 md:grid-cols-2">
              <Image
                src="/assets/images/service-details/image-2.webp"
                alt="service image 2"
                width={640}
                height={426}
                className="rounded-5"
            ...
            <div className="mt-2.5 grid grid-cols-[1fr_260px] gap-6">
              ...
              <Image
                src="/assets/images/service-details/image-3.webp"
                alt="service image 2"
                width={640}
                height={870}
                className="rounded-5"
