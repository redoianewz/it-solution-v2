...
const authorData: AuthorProps = {
  image: {
    src: '/assets/images/blog/author-1.webp',
    alt: 'author image 1',
  },
  name: 'Naturials paul',
  about:
        ...
        <div className="grid gap-30px lg:grid-cols-[1fr_410px]">
          <div>
            <div className="[&_p+P]:mt-4">
              <Image
                src="/assets/images/blog/blog-details-1.webp"
                alt="blog single 1"
                width={850}
                height={538}
                placeholder="blur"
              ...
              <Image
                src="/assets/images/blog/blog-details-2.webp"
                alt="blog single 2"
                width={850}
                height={352}
                placeholder="blur"
              ...
              <div className="flex flex-col items-start gap-x-6 gap-y-5 md:flex-row">
                <Image
                  src="/assets/images/blog/author-2.webp"
                  alt="Stanio lainto"
                  width={85}
                  height={87}
                  placeholder="blur"
